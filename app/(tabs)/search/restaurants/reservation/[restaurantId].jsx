...
export default function ReservationScreen() {
  ...
  // 🔹 NEW: track context of errors: 'none' | 'dateOnly' | 'submit'
  const [errorContext, setErrorContext] = useState('none');
  ...
  const handleConfirmDate = (dateObj) => {
    ...
    setTime('');
    hideDatePicker();
    // date selected successfully → clear date-only context
    setErrorContext('none');
  };
  ...
  const openTimeSheet = () => {
    if (!date) {
      // ❗ Only show date validation, not full form errors
      setErrorContext('dateOnly');
      setShowErrors(true);
      return;
    }
    setErrorContext('none');
                ...
                <View style={[styles.field, styles.half]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) => {
                      ...
                      setFirstNameError(validateNameValue(cleaned));
                    }}
                    placeholderTextColor={Colors.placeholder}
                  />
                  {!!firstNameError && (
                ...
                <View style={[styles.field, styles.half]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) => {
                      const cleaned = t.replace(/[^A-Za-z' -]/g, '');
                      setLastName(cleaned);
                      setLastNameError(validateNameValue(cleaned));
                    }}
                    placeholderTextColor={Colors.placeholder}
                  />
                  {!!lastNameError && (
